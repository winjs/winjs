...
(function () {
    ...
    module.exports = function (grunt) {
        ...
        grunt.registerTask("quick", ["clean", "ts:src", "less", "concat", "onefile:base", "requirejs:ui", "requirejs:intrinsics", "requirejs:tv", "requirejs:mediaplayerCss", "requirejs:mediaplayerJs", "copy:fonts", "_postProcess"]);
        grunt.registerTask("default", ["_preBuild", "onefile:base", "requirejs:ui", "requirejs:intrinsics", "requirejs:tv", "requirejs:mediaplayerCss", "requirejs:mediaplayerJs", "_copyFinal", "replace", "_postProcess"]);
