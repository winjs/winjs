...
module WinJS.Utilities {
    ...
    class Event {
        ...
        private _stopImmediatePropagationCalled:boolean;

        constructor(type:string=null, detail=null, target=null) {
            this.detail = detail;
            this.target = target;
        ...
        public get stopImmediatePropagationCalled() {
            return this._stopImmediatePropagationCalled;
        }
    ...
    export var eventMixin = {
        ...
        dispatchEvent: function (type:string, details:any) {
            ...
            if (listeners) {
                var eventValue = new Event(type, details, this);
