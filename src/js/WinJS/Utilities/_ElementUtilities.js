...
define([
    ...
    //    // We will style the resizemometer element to have the same height and width as it's nearest positioned ancestor.
    ...
    //        this._objectElementLoadHandlerBound = this.__objectElementLoadHandlerBound.bind(this);
    //        this._objectElementResizeHandlerBound = this.__objectElementResizeHandlerBound.bind(this);

    //    }, {
    //        /**
    //         * The HTMLObjectElement generated by the Resizemometer
    //        **/
    //        element: {
    //            get: function () {
    ...
    //        },
    //        /**
    //         * Tells the Resizemometer when to start reacting to size changes. 
    //         * PRECONDIION: The Resizemometer element should already be in the DOM as a child of the element we want to detect size changea for.
    //        **/
    //        monitor: function Resizemometer_monitor() {
    ...
    //            //    objEl.onload = function handleObjectLoad() {
    //            //        var objWindow = objEl.contentDocument.defaultView;
    //            //        objWindow._frameElement = objWindow.frameElement || objEl;
    //            //        objWindow.addEventListener('resize', this._objectElementResizeHandlerBound);
    //            //        c();
    //            //    }.bind(this);

    //            //    // Trigger load event
    //            //    that.element.data = "about:blank";

    //            //});
    //        },
    //        _objectElementLoadHandlerBound: function Resizemometer__objectElementLoadHandlerBound() {
    //            var objEl = this.element;
    //            var objWindow = objEl.contentDocument.defaultView;
    //            //objWindow._frameElement = objWindow.frameElement || objEl;
    //            objWindow.addEventListener('resize', this._objectElementResizeHandlerBound);
    ...
    //        _objectElementResizeHandlerBound: function Resizemometer__objectElementResizeHandlerBound(e) {
    //            // Use requestAnimationFrame to batch consecutive resize events.
    //            if (this._pendingResizeAnimationFrame) {
    //                window.cancelAnimationFrame(this._pendingResizeAnimationFrame);
    //            }
    //            this._pendingResizeAnimationFrame = window.requestAnimationFrame(function () {
    //                //var trigger = objEl._host;
    //                //trigger.__resizeListeners__.forEach(function (fn) {
    //                //    fn.call(trigger, e);
    //                //});
    ...
    //                objWindow.removeEventListener('resize', this._objectElementResizeHandlerBound);
    //            }
    //        }
    //    }, {});
