...
/// <part name="commandingSurface-overflowarea" class="win-toolbar-overflowarea" locid="WinJS.UI._CommandingSurface_part:CommandingSurface-overflowarea">The container for toolbar commands that overflow.</part>
