...
], function searchboxInit(_LightDismissService, _Global, _WinRT, _Base, _ErrorFromName, _Events, _Resources, Animations, BindingList, Repeater, _Control, _ElementListUtilities, _ElementUtilities, _Hoverable, _SearchSuggestionManagerShim) {
    "use strict";
                ...
                focusOnKeyboardInput: {
                    ...
                    set: function (value) {
                        if (this._focusOnKeyboardInput && !value) {
                            _LightDismissService.removeEventListener(this.element, "requestingfocusonkeyboardinput", this._requestingFocusOnKeyboardInputHandlerBind);
                        } else if (!this._focusOnKeyboardInput && !!value) {
                            _LightDismissService.addEventListener(this.element, "requestingfocusonkeyboardinput", this._requestingFocusOnKeyboardInputHandlerBind);
                        }
