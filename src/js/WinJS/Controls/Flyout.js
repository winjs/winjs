    ...
    _Base.Namespace._moduleDefine(exports, "WinJS.UI", {
        ...
        Flyout: _Base.Namespace._lazy(function () {
            ...
            _Base.Class.mix(Flyout, _LightDismissService.LightDismissableElement, {
                ...
                ld_edgyCompleted: function (edgyEvent) {
                    // TODO: Should the right click logic be provided by the LightDismissableElement mixin?
                    // TODO: It's strange that Overlay is the one that manages _containsRightMouseClick but Flyout is the
                    //       one that uses it.
                    // TODO: SettingsFlyout probably needs the same function
                    if (this._containsRightMouseClick) {
                        edgyEvent.stopPropagation(); // Don't let anybody else see edgyCompleted
                        edgyEvent.preventDefault(); // Don't let edgyCompleted turn into a light dismiss event 
                    }
                },
