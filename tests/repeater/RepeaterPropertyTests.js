...
WinJSTests.RepeaterPropertyTests = function () {
    "use strict";
    ...
    this.testUpdateDataProperty = function (complete) {
    ...
    this.testUpdateTemplateProperty = function (complete) {
        ...
        repeater.template = createRenderer("new-template");
    ...
    this.testWinControlExpando = function (complete) {
        var elem = document.getElementById("RepeaterTests");
    ...
    this.testElementFromIndexFunction = function (complete) {
        var data = utils.createWeekdaysList(),
            elem = document.getElementById("RepeaterTests");
