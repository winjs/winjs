...
CorsicaTests.Nav2Tests = function () {
    "use strict";
    this.testNavigationEvents = function (complete) {
    ...
    this.testNavigationEventsTyped = function (complete) {
        WinJS.Navigation.history = {};
        var navHit = false;
        var navPromiseHit = false;
        var navingHit = false;
    ...
    this.testNavigationErrors = function (complete) {
        WinJS.Navigation.history = {};
        var navHit = false;
        var navingHit = false;
        var navingPromiseHit = false;
    ...
    this.testBasicNavigation = function (complete) {
        WinJS.Navigation.history = {};
    ...
    this.testCanceledNavigation = function (complete) {
        var cancelBeforeNav = function (e) {
            e.preventDefault();
        };
    ...
    this.testStateRoundtrip = function (complete) {
        WinJS.Navigation.history = {};
        WinJS.Navigation.navigate("home", {a:123});
        LiveUnit.Assert.isFalse(WinJS.Navigation.canGoBack);
        LiveUnit.Assert.isFalse(WinJS.Navigation.canGoForward);
    ...
    this.testBackForwardDepthTest = function (complete) {
        WinJS.Navigation.history = {};
    ...
    this.testInitialNavigation = function (complete) {
        WinJS.Navigation.history = {
            backStack: [],
    ...
    this.testStateManip = function (complete) {
        WinJS.Navigation.history = {};
    ...
    this.testCheckEventErrors = function (complete) {
        WinJS.Navigation.history = {};
        var failed1 = "unset";
        var failed2 = "unset";
        ...
        LiveUnit.Assert.isTrue(failed1);
        LiveUnit.Assert.isTrue(failed2);

        complete();
    };

    // use different types for location and state
    this.testTypeAsLocationState = function() {
        WinJS.Navigation.history = {};
    ...
    this.testBoundaryConditions = function(complete) {
        WinJS.Navigation.history = {};
