...
RatingInstantiationTests = function () {
    ...
    this.testRating_Instantiation = function () {
    ...
    this.testRating_Instantiation_DynamicAdd = function () {
    ...
    this.testRating_dir_RTL_IncreasedMax = function () {
        document.getElementById("rating").setAttribute("dir", "rtl");
    ...
    this.testRating_dir_Swap = function () {
    ...
    this.testRating_Instantiation_MaxRating_Random = function () {
        for (var i = 1; i < 8; ++i) {
    ...
    this.testRating_Instantiation_MaxRating_Invalid_Negatives = function () {
        for (var i = 0; i < 10; ++i) {
    ...
    this.testRating_Instantiation_MaxRating_Invalid_NumbersAsStrings = function () {
        for (var i = 0; i < 10; ++i) {
    ...
    this.testRating_Instantiation_MaxRating_Invalid_Nonsense = function () {
        for (var i = 0; i < 10; ++i) {
    ...
    this.testRating_Instantiation_AverageRating_CustomMax = function () {
        for (var i = 0; i < 10; ++i) {
    ...
    this.testRating_Instantiation_AverageRating_Floats_CustomMax = function () {
        for (var i = 0; i < 10; ++i) {
    ...
    this.testRating_Instantiation_AverageRating_Invalid_GreaterThanCustomMax = function () {
        var newMax = ratingUtils.randomNewMaxRating(25, ratingUtils.defaultMaxRating);
    ...
    this.testRating_Instantiation_AverageRating_Invalid_Negatives = function () {
        for (var i = 0; i < 10; ++i) {
    ...
    this.testRating_Instantiation_AverageRating_Invalid_Nonsense = function () {
        for (var i = 0; i < 10; ++i) {
    ...
    this.testRating_Instantiation_UserRating_CustomMax = function () {
        for (var i = 0; i < 10; ++i) {
            var newMax = ratingUtils.randomNewMaxRating(50, ratingUtils.defaultMaxRating);
    ...
    this.testRating_Instantiation_UserRating_Invalid_GreaterThanCustomMax = function () {
        var newMax = ratingUtils.randomNewMaxRating(50, ratingUtils.defaultMaxRating);
    ...
    this.testRating_Instantiation_UserRating_Invalid_Floats_CustomMax = function () {
        for (var i = 0; i < 10; ++i) {
            var newMax = ratingUtils.randomNewMaxRating(50, ratingUtils.defaultMaxRating);
    ...
    this.testRating_Instantiation_UserRating_Invalid_Negatives = function () {
        for (var i = 0; i < 10; ++i) {
    ...
    this.testRating_Instantiation_UserRating_Invalid_Nonsense = function () {
        for (var i = 0; i < 10; ++i) {
    ...
    this.testRating_Instantiation_disabled_Invalid_Numbers = function () {
    ...
    this.testRating_Instantiation_disabled_Invalid_Nonsense = function () {
        for (var i = 0; i < 10; ++i) {
    ...
    this.testRating_Instantiation_enableClear_Invalid_Numbers = function () {
    ...
    this.testRating_Instantiation_enableClear_Invalid_Nonsense = function () {
        for (var i = 0; i < 10; ++i) {
    ...
    this.testRating_Instantiation_tooltipStrings_PlainText_DefaultMax = function () {
        var tooltipStrings = [
                "I hated it!",
                "I didn't like it.",
                "It was Okay",
    ...
    this.testRating_Instantiation_tooltipStrings_PlainText_CustomMax = function () {
        for (var i = 0; i < 5; ++i) {
            var newMax = ratingUtils.randomNewMaxRating(25, ratingUtils.defaultMaxRating);
    ...
    this.testRating_Instantiation_tooltipStrings_HTML_CustomMax = function () {
        for (var i = 0; i < 5; ++i) {
            var newMax = ratingUtils.randomNewMaxRating(25, ratingUtils.defaultMaxRating);
    ...
    this.testRating_Instantiation_tooltipStrings_NULL_CustomMax = function () {
        for (var i = 0; i < 5; ++i) {
            var newMax = ratingUtils.randomNewMaxRating(25, ratingUtils.defaultMaxRating);
    ...
    this.testRating_Instantiation_tooltipStrings_TooFew_CustomMax = function () {
        for (var i = 0; i < 5; ++i) {
            var newMax = ratingUtils.randomNewMaxRating(25, ratingUtils.defaultMaxRating);
    ...
    this.testRating_Instantiation_tooltipStrings_TooMany_CustomMax = function () {
        for (var i = 0; i < 5; ++i) {
...
LiveUnit.registerTestClass("RatingInstantiationTests");
