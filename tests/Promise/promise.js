...
CorsicaTests.Promise = function () {
    ...
    this.testCallingCompleteMultipleTimes = function () {
        q.clear();
    ...
    this.testCallingErrorMultipleTimes = function () {
        q.clear();
    ...
    this.testCallingCompleteAndThenError = function () {
        q.clear();
    ...
    this.testCallingErrorAndThenComplete = function () {
        q.clear();
    ...
    this.testCallingCompleteAfterProgress = function () {
        q.clear();
    ...
    this.testCallingProgressAfterComplete = function () {
        q.clear();
    ...
    this.testCallingErrorAfterProgress = function () {
        q.clear();
    ...
    this.testCallingProgressAfterError = function () {
        q.clear();
    ...
    this.testThenPartialRegistration1 = function () {
        q.clear();
    ...
    this.testThenPartialRegistration2 = function () {
        q.clear();
    ...
    this.testThenPartialRegistration3 = function () {
        q.clear();
    ...
    this.testThenPartialRegistration4 = function () {
        q.clear();
    ...
    this.testThenPartialRegistration5 = function () {
        q.clear();
    ...
    this.testProgressIsNotBuffered = function () {
        q.clear();
    ...
    this.testProgressWaterfall = function () {
        q.clear();
    ...
    this.testCancellationOfConstantPromise = function () {
        q.clear();
    ...
    this.testCancellationOfInFlightPromise = function () {
        q.clear();
    ...
    this.testCancellationOfTree = function () {
        q.clear();
        ...
        var p3 = WinJS.Promise.join({ p1: p1, p2: p2 }).
            then(function (values) { return asyncAddWithCancellation(value, 4, onCancel); });
    ...
    this.testPromiseDeadlock = function () {
        q.clear();
    ...
    this.testPromiseDeadlockCancellation = function () {
        q.clear();
    ...
    this.testBlockingOfCancelation = function () {
        q.clear();
    ...
    this.testCancellationOnJoinOfSamePromise = function () {
        q.clear();
    ...
    this.testErrorRecovery = function () {
        q.clear();
    ...
    this.testErrorWithFork = function () {
        q.clear();
    ...
    this.testExceptionFromCompleteHandler = function() {
        q.clear();
    ...
    this.testFallthroughComplete = function () {
        q.clear();
    ...
    this.testProgressExceptionIsIgnored = function () {
        q.clear();
    ...
    this.testPromise_As = function () {
        q.clear();

        var p = asyncAdd(1, 2);
        LiveUnit.Assert.isTrue(p instanceof WinJS.Promise);
        LiveUnit.Assert.isTrue(p === WinJS.Promise.as(p));

        var o = { a: 1 };
        var p1 = WinJS.Promise.as(o);
        LiveUnit.Assert.isFalse(o === p1);
        var hitCompleteCount = 0;
        var p1Value;
    ...
    this.testPromise_AnyWithNonPromiseInput = function () {
        q.clear();
    ...
    this.testPromise_AnyWithAllNonPromiseInput = function () {
        q.clear();
    ...
    this.testPromise_AnyWithError = function () {
        q.clear();
    ...
    this.testPromise_AnyWithError2 = function () {
        q.clear();
    ...
    this.testPromise_AnyCancellation = function () {
        q.clear();
    ...
    this.testPromise_AnyWithRecord = function () {
        q.clear();
    ...
    this.testPromise_wrapCancellation = function () {
        var hitCompleteCount = 0;
    ...
    this.testPromise_wrapErrorCancellation = function () {
        var hitCompleteCount = 0, hitErrorCount = 0;
    ...
    this.testPromise_Join = function () {
        q.clear();
    ...
    this.testPromise_JoinProgress = function () {
        q.clear();
    ...
    this.testPromise_JoinWithArray = function () {
        q.clear();
    ...
    this.testPromise_JoinWithError = function () {
        q.clear();
    ...
    this.testPromise_JoinWithNonPromiseInput = function () {
        q.clear();
    ...
    this.testPromise_JoinWithAllNonPromiseInput = function () {
        q.clear();
    ...
    this.testPromise_Then = function () {
        q.clear();
    ...
    this.testInterop = function () {
    };

    this.testTimeoutNoWait = function (complete) {
        var i = 0;
    ...
    this.testTimeoutOfPromisesWhichComplete = function (complete) {
        var completeP;
    ...
    this.testTimeoutNoWaitCancel = function (complete) {
        var i = 0;
    ...
    this.testTimeoutWaitCancel = function (complete) {
        var i = 0;
    ...
    this.testThenEach = function (complete) {
    ...
    this.testCompletePromise = function () {
        var hitCompleteCount = 0, hitErrorCount = 0, hitProgressCount = 0;
    ...
    this.testErrorPromise = function () {
        var hitCompleteCount = 0, hitErrorCount = 0, hitProgressCount = 0;
    ...
    this.testOnErrorHandler = function () {
    ...
    this.testOnErrorDoesNotSeeCancelation = function () {
    ...
    this.testOnErrorHandlerPolicyWithHandledError = function (complete) {
    ...
    this.testOnErrorHandlerPolicyWithUnhandledError = function (complete) {
        var unhandledAfterPostCount = 0;
        var unhandledErrors = [];
        WinJS.Promise.onerror = function (evt) {
            var details = evt.detail;
    ...
    this.testCorrectnessOfErrors = function(){
    ...
    this.testEmptyAny = function (complete) {
        WinJS.Promise.any([]).
            then(null, errorHandler).
            then(complete);
    };

    this.testStaticCanceledPromise = function (complete) {
        var hitCount = 0;
        WinJS.Promise.as()
    ...
    this.testSignal = function (complete) {
        var hitComplete = 0;
        var hitError = 0;
        var hitProgress = 0;
    ...
    this.testSignalError = function (complete) {
        var hitComplete = 0;
        var hitError = 0;
        var hitProgress = 0;
        var s = new WinJS._Signal();
    ...
    this.testNestedCancelationRecovery = function (complete) {
        var hitUnexpected = 0;
        var hitP1Complete = 0;
        var hitP2Complete = 0;
        var hitP3Complete = 0;
    ...
    this.testJoiningCanceledPromisesCancels = function () {
        var hitCompleteCount = 0, hitErrorCount = 0;
    ...
    this.testJoinSomeCanceledAndOtherFailedPromisesFails = function () {
        var hitCompleteCount = 0, hitErrorCount = 0;
    ...
    this.testJoinSomeCanceledAndOtherCompletedPromisesCancels = function () {
        var hitCompleteCount = 0, hitErrorCount = 0;
    ...
    this.testAnyCanceledPromisesCancels = function () {
        var hitCompleteCount = 0, hitErrorCount = 0;
    ...
    this.testAnySomeCanceledPromisesStillSucceeds = function () {
        var hitCompleteCount = 0, hitErrorCount = 0;
    ...
    this.testCancelingPromiseWhichErrorCorrectsTheCancel = function () {
        var hitCount = 0;
        var complete;
    ...
    this.testFIFODelivery = function () {
        var c;
