...
module CorsicaTests {
    ...
    var _Constants;
    var _ToolBar2Constants;
    var _element;
    WinJS.Utilities._require(["WinJS/Controls/AppBar/_Constants"], function (constants) {
        _Constants = constants;
    })
    WinJS.Utilities._require(["WinJS/Controls/ToolBar2/_Constants"], function (constants) {
        _ToolBar2Constants = constants;
    })
    ...
    //testAppBarDispose["Description"] = "Unit test for dispose requirements.";
        ...
        testCommandsLayoutKeyboarding = function (complete) {
            ...
            */
            ...
            // Using commands layout, since this keyboarding logic is validated in the menu layout on ToolBar2 unit tests.
        ...
        function verifyIsOpen(appBar) {
            ...
            function verifyHasInvokeButton(appBar) {
                ...
                if (appBar.winControl.layout === _Constants.appBarLayoutMenu && 
                    ...
                    invokeButton = appBar.querySelector("." + _ToolBar2Constants.overflowButtonCssClass);
                }
        ...
        testMenuLayoutConstruction = function (complete) {
            ...
            Helper.waitForEvent(appBar, "aftershow").then(function () {
                var toolbarEl = appBar.element.querySelector("." + Helper.ToolBar2.Constants.controlCssClass);
                var toolbar = toolbarEl.winControl;

                LiveUnit.Assert.isNotNull(toolbarEl, "ToolBar2 element not found");
                ...
                Helper.ToolBar2.verifyMainActionVisibleCommandsLabels(toolbar, ["Button 0", "Separator", "Button 1"]);
                Helper.ToolBar2.verifyOverflowAreaCommandsLabels(toolbar, ["Button 2", "Button 3", "Button 4"]);
        ...
        testMenuLayoutShowHideCommands = function (complete) {
            ...
            var toolbarEl = appBar.element.querySelector("." + Helper.ToolBar2.Constants.controlCssClass);
            var toolbar = toolbarEl.winControl;
            Helper.ToolBar2.verifyMainActionVisibleCommandsLabels(toolbar, ["Button 1", "Button 2", "Separator", "Button 3", "Button 4"]);
            Helper.ToolBar2.verifyOverflowAreaCommandsLabels(toolbar, ["Secondary Button 1", "Secondary Button 2", "Secondary Button 3"]);

            appBar.showOnlyCommands(["Button1", "Button3", "SecButton1"]);

            WinJS.Utilities.Scheduler.schedule(() => {
                Helper.ToolBar2.verifyMainActionVisibleCommandsLabels(toolbar, ["Button 1", "Button 3"]);
                Helper.ToolBar2.verifyOverflowAreaCommandsLabels(toolbar, ["Secondary Button 1"]);

                appBar.showCommands(["Button1", "Button4", "Button3", "SecButton1"]);

                WinJS.Utilities.Scheduler.schedule(() => {
                    Helper.ToolBar2.verifyMainActionVisibleCommandsLabels(toolbar, ["Button 1", "Button 3", "Button 4"]);
                    Helper.ToolBar2.verifyOverflowAreaCommandsLabels(toolbar, ["Secondary Button 1"]);

                    appBar.hideCommands(["SecButton1"]);
                    WinJS.Utilities.Scheduler.schedule(() => {
                        Helper.ToolBar2.verifyMainActionVisibleCommandsLabels(toolbar, ["Button 1", "Button 3", "Button 4"]);
                        Helper.ToolBar2.verifyOverflowAreaCommandsLabels(toolbar, []);

                        appBar.showOnlyCommands(["SecButton1"]);
                        WinJS.Utilities.Scheduler.schedule(() => {
                            Helper.ToolBar2.verifyMainActionVisibleCommandsLabels(toolbar, []);
                            Helper.ToolBar2.verifyOverflowAreaCommandsLabels(toolbar, ["Secondary Button 1"]);
