...
SearchBoxTests.SuggestionShimTests = function () {
    ...
    this.testSuggestionVectorShim = function testVectorChangedEvent() {
        var numFired = 0;
    ...
    this.testSearchSuggestionCollectionShim = function () {
    ...
    this.testAsyncSearchSuggestionsRequestedHandler = function testAsyncSearchSuggestionsRequestedHandler(complete) {
        ...
        deferralCompletion.promise.done(function () {
            suggestionsAreEqual([syncSuggestion, asyncSuggestion], ssm);
            complete();
        });
    };

    this.testHistoryOrderingPolicies = function testHistoryOrderingPolicies() {
