...
PVLJSFunctionTests = function () {
    ...
    this.testFadeIn = function (signalTestCaseCompleted) {
		var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
    ...
    this.testFadeOutQuerySelectorAll = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
    ...
    this.testFadeOutArray = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testFadeOutNullElement = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
    ...
    this.testPointerDown = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testPointerUp = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
            var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
        ...
        WinJS.UI.Animation.pointerDown(target).then
			(function () {
				var start = WinJS.Utilities._now();
				WinJS.UI.Animation.pointerUp(target);}).done
					(verifyAnimation);
    }

    //This is to test showPanel funciton by passing one element
    this.testShowPanel = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testHidePanel = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
            var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testHidePanelComplete = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testShowEdgeUI = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testHideEdgeUI = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testShowPopup = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testHidePopup = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testDragBetweenEnter = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testDragBetweenLeave = function (signalTestCaseCompleted) {
		var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testDragSourceStart = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testDragSourceEnd = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
        ...
        var list = document.querySelectorAll(".bar");
        LiveUnit.LoggingCore.logComment(list.length);
        var target = document.getElementById("div1");
        var affected = util.getRestOfList(list, target);
    ...
    this.testCollapse = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testExpand = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
   ...
   this.testReposition = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
     ...
     this.testEnterContent = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testExitContent = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testCrossFade = function (signalTestCaseCompleted) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testSwipeSelect = function (signalTestCaseComplete) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testSwipeDeselect = function (signalTestCaseComplete) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testDeleteFromList = function (signalTestCaseComplete) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testAddToList = function (signalTestCaseComplete) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
        ...
        var affected = util.getRestOfList(document.querySelectorAll(".bar"));
    ...
    this.testPeek = function (signalTestCaseComplete) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
        ...
        var peek = WinJS.UI.Animation.createPeekAnimation(div2, div1);
    ...
    this.testUpdateBadge = function (signalTestCaseComplete) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testSwipeReveal = function (signalTestCaseComplete) {
        var verifyAnimation = function () {
			var end = WinJS.Utilities._now();
			var duration = end - start;
			LiveUnit.LoggingCore.logComment("Verify duration:");
    ...
    this.testCancelAnimation = function (signalTestCaseComplete) {
        var verifyAnimation = function() {
            promise.cancel();
    ...
    this.testCancelTransition = function (signalTestCaseComplete) {
        var callback = function() {
            promise.cancel();
            LiveUnit.Assert.isTrue(result);
            verifier.rectAfter = div1.getBoundingClientRect();
        ...
        var target = document.getElementById("div1");
        verifier.rectBefore = div1.getBoundingClientRect();
    ...
    this.testCancelAnimationBeforeStart = function() {
        var div1 = document.getElementById("div1");
        var div2 = document.getElementById("div2");
        var promise = WinJS.UI.Animation.enterPage([div1, div2]).then(onComplete, onError);
    ...
    this.testCancelEmptyAnimation = function() {
        ...
        LiveUnit.Assert.isTrue(result === null); //Verifty onComplete is not fired yet.
        WinJS.Utilities._setImmediate(function() {promise.cancel(); LiveUnit.Assert.isTrue(result);});
    }
    ...
    this.testCancelAnimationWhileFinishing = function(signalTestCaseComplete) {
        var callback = function() {
            LiveUnit.Assert.isTrue(result); //Verify onComplete is fired by setting result = true;
            signalTestCaseComplete();
        }
    ...
    this.testCancelPartOfAnimation = function(signalTestCaseComplete) {
        var callback = function() {
...
LiveUnit.registerTestClass("PVLJSFunctionTests");
