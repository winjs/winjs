...
(function () {
    ...
    WinJSTests.ListLayoutTests = function () {
        ...
        [null, WinJS.UI.Orientation.horizontal, WinJS.UI.Orientation.vertical].forEach(function (orientation) {
            this["testLayout_" + orientation] = function (complete) {
        ...
        this.testLayoutWhileInvisible = function (complete) {
            function test(groupsEnabled) {
        ...
        this.testItemsFromRange = function (complete) {
            function test(groupsEnabled) {
        ...
        this.testGetAdjacent = function (complete) {
            function test(groupsEnabled) {
                ...
                var layout = new WinJS.UI.ListLayout({ orientation: "vertical" }),
                    count = 10,
                    listView = new SimpleListView(document.getElementById("ListLayoutListView"), {
                        layout: layout,
                        groupsEnabled: groupsEnabled,
    ...
    WinJSTests.UniformGridLayoutTests = function (complete) {
            ...
            this["testLayout_" + orientation] = function (complete) {
                function test(groupsEnabled) {
                    var layoutOptions = orientation ? { orientation: orientation } : {},
                        layout = new WinJS.UI.GridLayout(layoutOptions),
                        count = 10,
                        itemsCount = (groupsEnabled ? [6, 4] : count),
        ...
        this.testItemFromRange = function (complete) {
    ...
    WinJSTests.CellSpanningGridLayoutTests = function (complete) {
        ...
        this.testAdjustedKeyForOrientationAndBarsWithCellspanningGridLayout = function (complete) {
        ...
        this.testLayout = function (complete) {
            var opts = {
        ...
        this.testLayoutWithMargins = function (complete) {
            var opts = {
        ...
        this.testLayoutParts = function (complete) {
        ...
        this.testGapHandling = function (complete) {
            var opts = {
        ...
        this.testHitTest = function (complete) {
            var opts = {
                listViewClass: "cellSpanningMargins",
                pattern: "b mmm ssssss",
                itemSizes: itemSizesWithMargins,
        ...
        this.testRemoveLastGroup = function (complete) {
            var data = [];
            for (var i = 0; i < 20; i++) {
        ...
        this.testInvalidGroupInfoResult = function (complete) {
            var count = 10,
                layoutResult,
                layout = new WinJS.UI.CellSpanningLayout({
        ...
        this.testInvalidItemInfo = function (complete) {
        ...
        this.testAsyncItemInfo = function (complete) {
    ...
    WinJSTests.GroupedGridLayoutTests = function (complete) {
        ...
        this.testUniformContainerSize = function (complete) {
            var count = 20;
            var opts = {
                listViewClass: "cellSpanningMargins",
                groups: [
        ...
        this.testInvalidUniformItemInfo = function (complete) {
        ...
        this.testLayoutClasses = function (complete) {
        ...
        this.testBackgroundLayout = function (complete) {
        ...
        this.testGetAdjacentBetweenGroups = function (complete) {
            function test(rtl) {
    ...
    WinJSTests.LayoutTests = function (complete) {
        ...
        this.testDefaultItemsContainerMargins = function (complete) {
        ...
        this.testSurfaceLength = function (complete) {
        ...
        this.testMeasuringContainerWithZeroSizedPlaceholder = function (complete) {
        ...
        this.testCancelationWithDefaultItemInfo = function (complete) {
            ...
            var itemCount = 100,
                ...
                layout = new WinJS.UI.GridLayout({ groupInfo: groupInfo }),
