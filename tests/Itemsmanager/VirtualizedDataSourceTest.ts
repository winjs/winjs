...
module WinJSTests {
        ...
        this._data = data || [];
            ...
            itemsFromIndex: function (requestIndex, countBefore, countAfter) {
                ...
                if (requestIndex >= length) {
                    return Promise.wrap(new WinJS.ErrorFromName(WinJS.UI.FetchError.doesNotExist.toString()));
                }
                if (requestIndex < 0) {
                    return Promise.wrap(new WinJS.ErrorFromName(WinJS.UI.FetchError.doesNotExist.toString()));
                }
    ...
    export class VirtualizedDataSourceTests {
        ...
        //
        testInvalidateAllOnEmptyThenInsert(complete) {
        ...
        testInsertOnEmptyList(complete) {
        ...
        xtestInsertOnEmptyListAfterCallingGetCount(complete) {
        ...
        //
        testRemoveCurrentListBindingElement(complete) {
        ...
        //
        testInsertsOnNonEmptyListBeforeFirstRequest(complete) {
        ...
        //
        testInsertsWithNoIndexAndAKeyThatIsNotBeingTracked(complete) {
            VDSLogging.options.log = function (message) {
        ...
        //
        testDataAdapterEatingCountCancelation(complete) {
...
LiveUnit.registerTestClass("WinJSTests.VirtualizedDataSourceTests");
