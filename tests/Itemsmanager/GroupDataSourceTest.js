...
var GroupDataSourceTests = function () {
    ...
    this.testGetCount = function (signalTestCaseCompleted) {
        testGetCount(itemCountDefault, signalTestCaseCompleted);
    };

    this.testGetCountEmpty = function (signalTestCaseCompleted) {
    ...
    this.testEnumeration = function (signalTestCaseCompleted) {
...
LiveUnit.registerTestClass("GroupDataSourceTests");
