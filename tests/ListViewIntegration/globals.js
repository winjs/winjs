...
// Abstract:
//
//   Expected Values for List View tests.
//
// Filename: globals.js
//-----------------------------------------------------------------------------
"use strict";
...
Expected.Control = { List: 'list', Grid: 'grid' };
Expected.Height = { Negative: -1, Medium: Math.floor(DEF_LISTVIEW_HEIGHT / 5 - DEF_LISTVIEW_HEIGHT / 16), Large: DEF_LISTVIEW_HEIGHT, Exceeds: DEF_LISTVIEW_HEIGHT + 1, Default: 30 };
Expected.Width = { Negative: -1, Medium: Math.floor(DEF_LISTVIEW_WIDTH / 5 - DEF_LISTVIEW_WIDTH / 16), Large: DEF_LISTVIEW_WIDTH, Exceeds: DEF_LISTVIEW_WIDTH + 1, Default: 30 };
Expected.Horizontal = { Grid: true, List: false};
Expected.Interaction = { Invalid: 'invalid', Multiselection: 'multi', Singleselection: 'single', Browse: 'none', Static: 'none', None : 'none' };
Expected.SelectionMode = { Invalid: 'invalid', Multi: 'multi', Single: 'single', None: 'none' };
// TODO: Do we still need margin for grid layout with groups?
Expected.GroupMargin = { Small: 1, Medium: 50, Large: 100 };
Expected.GroupHeaderPosition = { Invalid: 'invalid', Left: 'left', Top: 'top' };
Expected.Reorder = { Invalid: 'invalid', True: true, False: false };
Expected.Exception = {
...
Expected.Direction = { ltr: "ltr", rtl: "rtl" };
Expected.ClassName = {
...
// TODO: Remove 2 below
Expected.Items = { Default: "default", VariableSize: "variablesize", GroupedContent: "groupedcontent" };
Expected.GroupHeader = { GroupByAlphabetContent: "groupbyalphabetcontent", GroupByAlphabetContent2: "groupbyalphabetcontent2" };
