...
(function (global, undefined) {
    ...
    Tests.ListViewIntegrationTestingWithBindingList = function () {
        ...
        this.testReversingListViewWithListBinding = function (complete) {
            //BugID:  629543
        ...
        this.testListViewWithBindingEnabledInSortedList = function (complete) {
            //BugID:  629543
            var sampleDataSource = [];
            for (var i = 0; i < 20; i++) {
                var d = "Corsica_" + i;
        ...
        this.testBindingWithFiltered = function (complete) {
            //BugID:  629543
            var sampleDataSource = [];
            for (var i = 0; i < 20; i++) {
                var d = "Corsica_" + i;
        ...
        this.testBindingWithSorted = function (complete) {
            //BugID:  629543
            var sampleDataSource = [];
        ...
        this.testGroupSorted = function (complete) {
            //BugID:  629543
        ...
        this.testListViewWithSortedProjectionSpecialCases = function (complete) {
            //BugID:  629543
            var sampleDataSource = [];
            for (var i = 0; i < 10; i++) {
        ...
        this.testListViewWithListMutations = function (complete) {
            //BugID:  629543
            var sampleDataSource = [];
            for (var i = 0; i < 20; i++) {
                var t = "Corsica_" + i;
        ...
        this.testListViewWithSortedListMutations = function (complete) {
            //BugID:  629543
            var sampleDataSource = [];
        ...
        this.testListViewWithFilteredListMutation = function (complete) {
            //BugID:  629543
            var sampleDataSource = [];
            for (var i = 0; i < 20; i++) {
                var d = "Corsica_" + i;
        ...
        this.testListViewWithSpecialGroupSortedCases = function (complete) {
            //BugID:  629543
            ...
            WinJS.UI.processAll().
                ...
                then(function () {
                    ...
                    var odd = grouped.groups.getItem(1);
        ...
        this.testAffectedRange = function (complete) {
            ...
            var sampleDataSource = range(0, 100).map(function (i) { return { title: i, detail: "Javascript Toolkit_" + i }; });
            var list = new WinJS.Binding.List(sampleDataSource);
            var dataSource = list.dataSource;
            var notificationHandler = { affectedRange: rangeTester.verify.bind(rangeTester) };
            var binding = dataSource.createListBinding(notificationHandler);
