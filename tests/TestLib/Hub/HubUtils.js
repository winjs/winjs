...
HubTests.Utilities = (function () {
    "use strict";
    // Helper functions
    window.HubHeaderTestTemplateJS = WinJS.Utilities.markSupportedForProcessing(function HubHeaderTestTemplateJS(item) {
                ...
                initialize: function (testHost) {
                    return {
                        ...
                        sectionsArray: [
                            ...
                            new WinJS.UI.HubSection(getListViewContent(testHost), { header: 'Section 0', isHeaderStatic: true }),
                            new WinJS.UI.HubSection(undefined, { header: 'Section 1' }),
                            new WinJS.UI.HubSection(undefined, { header: 'Section 2' }),
                            new WinJS.UI.HubSection(undefined, { header: 'Section 3', isHeaderStatic: true }),
                            new WinJS.UI.HubSection(undefined, { header: 'Section 4' })
                        ],
            ...
            },
            {
                initialize: function () {
                    return {
                        ...
                        sectionsArray: [
                            //metadata for sections
                            new WinJS.UI.HubSection(undefined, { header: 'Section 0', isHeaderStatic: true }),
                            new WinJS.UI.HubSection(undefined, { header: 'Section 1' }),
                            new WinJS.UI.HubSection(undefined, { header: 'Section 2' }),
                            new WinJS.UI.HubSection(undefined, { header: 'Section 3', isHeaderStatic: true }),
                            new WinJS.UI.HubSection(undefined, { header: 'Section 4' })
    ...
    function HubTests_test(that, testHostSelector, testNamePrefix, testFunction, options, filter) {
            ...
            if (!filter || filter(configurations[i])) {
                (function (i) {
                    ...
                    that[testName] = function (complete) {
                        ...
                        HubTests_insertHub(testHost, config);
    ...
    function HubTests_insertHub(testHost, config) {
        var control;
    ...
    function HubTests_verifyOrientation(control, expected) {
    ...
    function HubTests_getAllHeaderElements(control) {
        return control.element.querySelectorAll("." + WinJS.UI.HubSection._ClassName.hubSectionHeader);
    }

    function HubTests_verifySections(control, sections, headerTemplate) {
        var sectionsInDOM = control.element.querySelectorAll("." + WinJS.UI.HubSection._ClassName.hubSection);
        ...
        for (var i = 0; i < sections.length; i++) {
            ...
            switch (typeof headerTemplate) {
                case "object":
                    var expectedHeader = document.createElement("div");
                    ...
                    LiveUnit.Assert.areEqual(expectedHeader.firstElementChild.innerHTML,
                        currentSection.querySelector("." + WinJS.UI.HubSection._ClassName.hubSectionHeaderContent).firstElementChild.innerHTML,
                ...
                default:
                    ...
                    headerElement.innerHTML = '<span class="' + WinJS.UI.HubSection._ClassName.hubSectionHeaderContent + ' ' + WinJS.UI.HubSection._Constants.ellipsisTypeClassName + '"></span>';

                    var headerElementContent = headerElement.firstElementChild;
                    ...
                    LiveUnit.Assert.areEqual(headerElementContent.innerHTML,
                        currentSection.querySelector("." + WinJS.UI.HubSection._ClassName.hubSectionHeaderContent).innerHTML,
                        "Header content does not match input");
            }
        }
    }

    function HubTests_waitForReady(control, delay) {
        return function (x) {
            return new WinJS.Promise(function waitForReady_Promise(c, e, p) {
                function waitForReady_handler(ev) {
                    if (control.loadingState === "complete") {
                        c(x);
                        control.removeEventListener(WinJS.UI.Hub._EventName.loadingStateChanged, waitForReady_handler);
                    } else {
                ...
                function waitForReady_work() {
                    if (control.loadingState === "complete") {
                        ...
                        control.addEventListener(WinJS.UI.Hub._EventName.loadingStateChanged, waitForReady_handler);
                    }
                }
    ...
    function HubTests_getScrollRange(control) {
    ...
    function HubTests_getSurfaceSpacers(control) {
        var surface = control.element.querySelector("." + WinJS.UI.Hub._ClassName.hubSurface);
    ...
    function HubTests_findCurrentSectionOnScreen(control) {
        ...
        var sectionElements = control.element.querySelectorAll("." + WinJS.UI.HubSection._ClassName.hubSection);
    ...
    return {
        HubHeaderTestTemplateJS: HubHeaderTestTemplateJS,
        test: HubTests_test,
        waitForReady: HubTests_waitForReady,
        insertHub: HubTests_insertHub,
        verifySections: HubTests_verifySections,
        verifyOrientation: HubTests_verifyOrientation,
        getAllHeaderElements: HubTests_getAllHeaderElements,
        getScrollRange: HubTests_getScrollRange,
        getSurfaceSpacers: HubTests_getSurfaceSpacers,
        findCurrentSectionOnScreen: HubTests_findCurrentSectionOnScreen
    };
})();