...
function AnimationVerifier() {
}

AnimationVerifier.prototype = (function () {
    var rectBefore = null;
    var rectAfter = null;
    ...
    return {
        ...
        VerifyEachElementStatusChange: function (f) {
            /// <summary>
            ...
            var ret = true;
            if (Array.isArray(this.rectBefore)) {
                  if (this.rectBefore.length !== this.rectAfter.length) {
                     ret = false;
                  } else {
                     for (var i = 0; ret && i < this.rectBefore.length; i++) {
                        ret = f(this.rectBefore[i], this.rectAfter[i], compareDouble);
                     }
                  }
            } else {
                  ret = f(this.rectBefore, this.rectAfter, compareDouble);
            }
        ...
        //             Public APIs
        //------------------------------------------------------------------
		VerifyCoordinateTransitionInProgress: function (startX, startY, destX, destY, currX, currY) {
			/// <summary>
        ...
        verifyTranslate2DAnimation: function (diffX, diffY, option) {
            /// <summary>
        ...
        VerifyScale2DTransition: function (ratioX, ratioY) {
            /// <summary>
        ...
        VerifyScale2DAnimation: function (ratioX, ratioY) {
            /// <summary>
	  ...
	  VerifyOpacityTransitionInProgress: function(elem) {
            /// <summary>
            ///     Verify opacity transition.
            /// </summary>
            /// <returns type="bool"/>
