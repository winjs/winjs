...
CorsicaTests.DatePicker = function () {
    "use strict";
    var glob;
    ...
    this.testMaxMinCurrentDatesFarBottom = function () {
        if (!isWinRTEnabled()) { return; }
    ...
    this.testMaxMinCurrentDatesMiddle = function () {
        if (!isWinRTEnabled()) { return; }
    ...
    this.testRoundTripWinRT = function () {
        if (isWinRTEnabled()) {
    ...
    this.testRedlines = function () {
        var controlElement = document.createElement("div");
        try {
            var control = new WinJS.UI.DatePicker(controlElement);
    ...
    this.testEmptyConstructor = function () {
        var control = new WinJS.UI.DatePicker();
    ...
    this.testElementProperty = function () {
        var controlElement = document.createElement("div");
        var control = new WinJS.UI.DatePicker(controlElement, { current: 'january 10, 1995' });
    ...
    this.testDateString2 = function () {
        var controlElement = document.createElement("div");
        var control = new WinJS.UI.DatePicker(controlElement, { current: '2/4/1995' });
    ...
    this.testDateString3 = function () {
        ...
        dateStrings.forEach(function (item) {
            ...
            myAreEqual("month of: " + item[dateString] + ", actual=" + control.current, item[month] - 1, control.current.getMonth());
            myAreEqual("date of: " + item[dateString] + ", actual=" + control.current, item[date], control.current.getDate());
            myAreEqual("year of: " + item[dateString] + ", actual=" + control.current, item[year], control.current.getFullYear());
        });
    };
    ...
    this.testDate = function () {
        ...
        var controlElement = document.createElement("div");
        var control = new WinJS.UI.DatePicker(controlElement, { current: date });
    ...
    this.testDateChange = function () {
        var controlElement = document.createElement("div");
        var picker = new WinJS.UI.DatePicker(controlElement, { current: new Date(2011, 7, 31) });
    ...
    this.testDatePattern = function () {
        if (window.Windows && Windows.Globalization && Windows.Globalization.Calendar) {
            var controlElement = document.createElement("div");
            try {
                var control = new WinJS.UI.DatePicker(controlElement, { current: new Date(2011, 6, 1), calendar: "GregorianCalendar" } );
                document.body.appendChild(controlElement);

                // specific elements of the datepicker corresponding to the classes
                var getYearElementValue = function () { return controlElement.querySelector(".win-datepicker-year").value; };
                var getMonthElementValue = function () { return controlElement.querySelector(".win-datepicker-month").value; };
                var getDateElementValue = function () { return controlElement.querySelector(".win-datepicker-date").value; };
    ...
    this.testDisabledTrue = function () {
        var controlElement = document.createElement("div");
        var control = new WinJS.UI.DatePicker(controlElement, { disabled: true });
    ...
    this.testDisabledFalse = function () {
        var controlElement = document.createElement("div");
        var control = new WinJS.UI.DatePicker(controlElement, { disabled: false });
    ...
    this.testAccessibilityAttributeVerification = function () {
        var controlElement = document.createElement("div");
        var control = new WinJS.UI.DatePicker(controlElement, { current: "January 1 2010", minYear: 2000, maxYear: 2020 });
        document.body.appendChild(controlElement);
        ...
        control.current = "February 1, 2011";
