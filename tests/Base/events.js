...
CorsicaTests.BaseEvents = function () {
    "use strict";

    this.testEventsMixin = function () {
    ...
    this.testEventsMixinRemoveWithMultipleEvents = function () {
        var TC = WinJS.Class.define();
        WinJS.Class.mix(TC, WinJS.Utilities.eventMixin);
    ...
    this.testEventsMixin_removeEvent = function () {
        var TC = WinJS.Class.define();
        WinJS.Class.mix(TC, WinJS.Utilities.eventMixin);
    ...
    this.testEventsMixin_cancelEvent = function () {
        var TC = WinJS.Class.define();
        WinJS.Class.mix(TC, WinJS.Utilities.eventMixin);
    ...
    this.testEventsMixin_stopPropagation = function () {
        var TC = WinJS.Class.define();
        WinJS.Class.mix(TC, WinJS.Utilities.eventMixin);
    ...
    this.testCreatingEventPropertiesWithEventMixins = function () {
    ...
    this.testCreatingEventPropertiesPreserveDOMOrdering = function () {
