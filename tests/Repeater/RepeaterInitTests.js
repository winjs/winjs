...
WinJSTests.RepeaterInitTests = function () {
    "use strict";
    ...
    this.testReloadWithExternalTemplate = function () {
        ...
        var repeater = new WinJS.UI.Repeater(document.querySelector("#RepeaterTests"));
    ...
    this.testInitJSCtorRendererFunction = function (complete) {
    ...
    this.testInitJSCtorInlineTemplate = function (complete) {
        var data = utils.createWeekdaysList(),
            elem = document.getElementById("RepeaterTests"),
            loadedEventFired = 0;
    ...
    this.testInitJSCtorBindingTemplate = function (complete) {
        var data = utils.createWeekdaysList(),
    ...
    this.testInitJSCtorBindingTemplateWinControl = function (complete) {
        var data = utils.createWeekdaysList(),
            root = document.getElementById("RepeaterTests"),
            loadedEventFired = 0;
    ...
    this.testInitMarkupRendererFunction = function (complete) {
        var data = utils.createWeekdaysList(),
            root = document.getElementById("RepeaterTests"),
            loadedEventFired = 0;
    ...
    this.testInitMarkupInlineTemplate = function (complete) {
        var data = utils.createWeekdaysList(),
            root = document.getElementById("RepeaterTests"),
            loadedEventFired = 0;
    ...
    this.testInitMarkupBindingTemplate = function (complete) {
        var data = utils.createWeekdaysList(),
            root = document.getElementById("RepeaterTests"),
            loadedEventFired = 0;
    ...
    this.testAriaAttributes = function (complete) {
        var data = utils.createWeekdaysList(),
            elem = document.getElementById("RepeaterTests"),
    ...
    this.testEmptyCtor = function (complete) {
        var data = utils.createWeekdaysList(),
            elem = document.getElementById("RepeaterTests"),
            loadedEventFired = 0;
        ...
        repeater.data = data;
        repeater.template = simpleRenderer;
    ...
    this.testNoTemplate = function (complete) {
        var data = utils.createWeekdaysList(),
            elem = document.getElementById("RepeaterTests");
    ...
    (function () {
        ...
        that.testRepeaterInListViewTemplate = generateTest(WinJS.UI.ListView);
        that.testRepeaterInFlipViewTemplate = generateTest(WinJS.UI.FlipView);
    }());

    // WinBlue: 66929 
    this.testNestedRepeaterInlineTemplate = function (complete) {
        ...
        WinJS.UI.processAll().
           then(function () {
               ...
               outerList.forEach(function (item, index) {
    ...
    (function () {
        ...
        that.testRepeaterDisposeSimpleRenderer = generateTest(simpleRenderer);
        that.testRepeaterDisposeWinJSRenderer = generateTest(utils.winJSCtrlRenderer);
        that.testRepeaterDisposeDisposableRenderer = generateTest(utils.disposableRenderer);
    })();

    this.testRepeaterDoubleDispose = function (complete) {
    ...
    this.testDuplicateConstructionException = function (complete) {
        var elem = document.getElementById("RepeaterTests");
    ...
    this.testAsyncTemplateException = function (complete) {
        var data = utils.createWeekdaysList(),
            elem = document.getElementById("RepeaterTests");
    ...
    this.testDeclarativeControlContainerWithItemContainerInlineTemplate = function (complete) {           
