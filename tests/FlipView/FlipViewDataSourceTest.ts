...
module WinJSTests {
    ...
    export class FlipViewDatasourceTests {
    ...
    function generate(name, testFunction) {
        function generateTest(orientation) {
            FlipViewDatasourceTests.prototype[name + "_" + orientation] = function (complete) {
                var element = document.getElementById("BasicFlipView"),
    ...
    generate("testFlipViewDatasourceProperty", datasourceTest);
    generate("testFlipViewRendererProperty", rendererTest);
    generate("testFlipViewDSAndRendererDuringAnimation", changeDuringAnimationTest);
    generate("testFlipViewChangeToNullDataSource", changeToNullDataSource);
    generate("testFlipViewInsertAndChangeInDataSource", insertAndChangeInDatasource);
    generate("testFlipViewShiftAndChangeInDataSource", shiftAndChangeInDatasource);
    generate("testFlipViewNavigateAndSpliceTwiceInDataSource", navigateAndSpliceTwiceInDataSource);
    generate("testFlipViewInsertJumpAndChangeInDataSource", insertJumpAndChangeInDataSource);
}
