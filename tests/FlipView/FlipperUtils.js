...
FlipperUtils.prototype = (function () {
    ...
    // Public methods
    return {
        flipperData: function FlipperUtils_flipperData() {
        ...
        flipperDataTemplate: function FlipperUtils_flipperDataTemplate(itemPromise) {
            ...
            function parentItemTemplate(itemPromise) {
                return itemPromise.then(function(item) {
                    ...
                    if (item.data.childFlipper) {
                        ...
                        var childFlipper = new WinJS.UI.FlipView(result, childOptions);
        ...
        basicFlipperID: function FlipperUtils_basicFlipperID() {
            /// <summary>
        ...
        ensureCurrentPage: function FlipperUtils_ensureCurrentPage(flipper, index, callback) {
            /// <summary>
        ...
        ensureNext: function FlipperUtils_ensureNext(flipper, callback, expectedPage) {
            /// <summary>
        ...
        ensurePrevious: function FlipperUtils_ensurePrevious(flipper, callback, expectedPage) {
            /// <summary>
        ...
        instantiate: function FlipperUtils_instantiate(elementID, options) {
            /// <summary>
            ...
            var itemDataSource = new WinJS.Binding.List(this.flipperData()).dataSource;
            ...
            var flipper = new WinJS.UI.FlipView(flipperElement, options);
            ...
            if (flipper) {
                ...
                this.verifyFlipperDomAccessibility(elementID);
            }
            else {
        ...
        isFlipperItemVisible: function FlipperUtils_isFlipperItemVisible(elementID) {
            ...
            if (flipperElement !== null) {
                var flipper = document.getElementById(this.basicFlipperID()).winControl;
                var parents = flipperElement.parentNode.parentNode.parentNode;
        ...
        removeFlipperDom: function FlipperUtils_removeFlipperDom() {
            /// <summary>
        ...
        verifyFlipperDomAccessibility: function FlipperUtils_verifyFlipperDomAccessibility(elementID) {
            /// <summary>
            ...
            if (flipper.orientation === "horizontal" ) {
                var prevInfo = flipperElement.getElementsByClassName("win-navleft")[0];
                var nextInfo = flipperElement.getElementsByClassName("win-navright")[0];
            }
            else {
        ...
        simpleArrayRenderer: function FlipperUtils_simpleArrayRenderer(itemPromise) {
            /// <summary>
        ...
        simpleArrayData: function FlipperUtils_simpleArrayData(totalItems) {
            /// <summary>
        ...
        getAllItemsFromDataSource: function FlipperUtils_retrieveItemsFromDataSource(itemDataSource) {
            /// <summary>
        ...
        insertItem: function FlipperUtils_insertItem(insertAction, onSuccess, onError, setEventHandlers) {
            /// <summary>
            ...
            /// </summary>
            var totalItems = 10,
                itemDataSourceObject = new WinJS.Binding.List(this.simpleArrayData(totalItems)).dataSource,
                errors = [],
                verifyPosition,
                flipper,
            ...
            if (setEventHandlers) {
                setEventHandlers(this.basicFlipperID());
            }
            ...
            var action = LiveUnit.GetWrappedCallback(function () {
                ...
                flipperUtilsObject.getAllItemsFromDataSource(itemDataSourceObject).then(function (items) {
                ...
                itemDataSourceObject.itemFromIndex(verifyPosition).then(function (item) {
                    ...
                    if (verifyItem.data.title === insertData.title) {
                        ...
                        var verify = LiveUnit.GetWrappedCallback(function (ev) {
                            ...
                            LiveUnit.Assert.isTrue(flipperUtilsObject.isFlipperItemVisible(insertData.title), "Flipper is not showing correct data.");
                        });
                        flipperUtilsObject.ensureCurrentPage(flipper, verifyPosition, verify);
                    }
                    else {
        ...
        moveItem: function FlipperUtils_moveItem(moveAction, onSuccess, onError, setEventHandlers) {
            /// <summary>
            ...
            function Complete() {
                ...
                itemDataSourceObject.itemFromIndex(verifyPosition).then(function (item) {
                    ...
                    if (verifyItem.data.title === moveData.data.title) {
                        ...
                        LiveUnit.LoggingCore.logComment("Attempt flip to new position...");
                        flipperUtilsObject.ensureCurrentPage(flipper, verifyPosition, CurrentPageCompleted);
                    }
                    else {
        ...
        removeItem: function FlipperUtils_removeItem(removeAction, onSuccess, onError, setEventHandlers) {
            ...
            /// </summary>
            var totalItems = 10,
                itemDataSourceObject = TestComponents.createTestDataSource(this.simpleArrayData(totalItems), controller, null),
                flipper,
                flipperDiv = document.getElementById(this.basicFlipperID()),
                removePosition,
                removeData,
        ...
        changeItem: function FlipperUtils_changeItem(changeAction, onSuccess, onError, setEventHandlers) {
            /// <summary>
                ...
                itemDataSourceObject.itemFromIndex(verifyPosition).then(function (item) {
                    ...
                    if (verifyItem.data.title === changeData.title) {
                        ...
                        var verify = LiveUnit.GetWrappedCallback(function () {
                            ...
                            LiveUnit.Assert.isTrue(flipperUtilsObject.isFlipperItemVisible(changeData.title), "Flipper is not showing correct data.");
                        });
